  ...
  const technologies = [
    {
      ...
      description:
        'NGOs can partner with Eco scrap to organize sustainability events clean-up drives, recycling programs, and workshops where users can actively participate and earn rewards for their involvement.',
