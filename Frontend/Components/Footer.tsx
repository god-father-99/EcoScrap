    ...
    return (
      ...
      <div className="text-center">
        ...
        <ul className="flex flex-wrap justify-center gap-x-8 gap-4 my-8">
          ...
          <li><a href="https://www.linkedin.com/in/luckykumarswain/" className="text-xl hover:text-gray-400">
            <svg xmlns="https://www.instagram.com/luckykumarswain/" className="inline w-7 h-7" viewBox="0 0 176 176">
              <g data-name="Layer 2">
          ...
          <li><a href="https://www.instagram.com/luckykumarswain/" className="text-xl hover:text-gray-400">
            <svg xmlns="https://www.instagram.com/luckykumarswain/" className="inline w-7 h-7" viewBox="0 0 24 24">
          ...
          <li><a href="#" className="text-xl hover:text-gray-400">
            <svg xmlns="https://www.instagram.com/luckykumarswain/" className="inline w-7 h-7" viewBox="0 0 1227 1227">
        ...
        <p className="text-base">Eco Scrap. All rights reserved.</p>
      </div>
    </footer>
      </div>
    )
